...
{
	//UE_LOG(LogTemp, Warning, TEXT("Super::OnOverlapBegin succedded")); //test for collision
...
{
	//UE_LOG(LogTemp, Warning, TEXT("Super::OnOverlapEnd succedded")); //test for collision
}